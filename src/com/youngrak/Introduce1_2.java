...
public class Introduce1_2 extends BaseActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.introduce1_2);
        
        new TopMenuInitializer(thisContext, (View)findViewById(R.id.top_menubar), "이용안내 및 신청");
        ...
        webview.loadUrl("http://www.cyberyoungrak.or.kr/m/1_2.php");
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if(appEx.isLogin()){
					Intent i = new Intent(thisContext, RequestSearch.class);
					startActivity(i);
				} else {
